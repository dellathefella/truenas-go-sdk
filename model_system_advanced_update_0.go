...
type SystemAdvancedUpdate0 struct {
	...
	SyslogTlsCertificateAuthority NullableInt32 `json:"syslog_tls_certificate_authority,omitempty"`
}
...
// GetSyslogTlsCertificateAuthority returns the SyslogTlsCertificateAuthority field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *SystemAdvancedUpdate0) GetSyslogTlsCertificateAuthority() int32 {
	if o == nil || o.SyslogTlsCertificateAuthority.Get() == nil {
		var ret int32
		return ret
	}
	return *o.SyslogTlsCertificateAuthority.Get()
}

// GetSyslogTlsCertificateAuthorityOk returns a tuple with the SyslogTlsCertificateAuthority field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *SystemAdvancedUpdate0) GetSyslogTlsCertificateAuthorityOk() (*int32, bool) {
	...
	return o.SyslogTlsCertificateAuthority.Get(), o.SyslogTlsCertificateAuthority.IsSet()
}
...
func (o *SystemAdvancedUpdate0) HasSyslogTlsCertificateAuthority() bool {
	if o != nil && o.SyslogTlsCertificateAuthority.IsSet() {
		return true
	}
...
// SetSyslogTlsCertificateAuthority gets a reference to the given NullableInt32 and assigns it to the SyslogTlsCertificateAuthority field.
func (o *SystemAdvancedUpdate0) SetSyslogTlsCertificateAuthority(v int32) {
	o.SyslogTlsCertificateAuthority.Set(&v)
}

// SetSyslogTlsCertificateAuthorityNil sets the value for SyslogTlsCertificateAuthority to be an explicit nil
func (o *SystemAdvancedUpdate0) SetSyslogTlsCertificateAuthorityNil() {
	o.SyslogTlsCertificateAuthority.Set(nil)
}
...
func (o *SystemAdvancedUpdate0) UnsetSyslogTlsCertificateAuthority() {
	o.SyslogTlsCertificateAuthority.Unset()
}
...
func (o SystemAdvancedUpdate0) MarshalJSON() ([]byte, error) {
	...
	if o.SyslogTlsCertificateAuthority.IsSet() {
		toSerialize["syslog_tls_certificate_authority"] = o.SyslogTlsCertificateAuthority.Get()
	}
