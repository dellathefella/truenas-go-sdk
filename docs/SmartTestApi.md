...
func main() {
    ...
    resp, r, err := apiClient.SmartTestApi.SmartTestDiskChoicesPost(context.Background()).Body(body).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SmartTestApi.SmartTestGet(context.Background()).Limit(limit).Offset(offset).Count(count).Sort(sort).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SmartTestApi.SmartTestIdIdDelete(context.Background(), id).Execute()
    if err != nil {
...
> SmartTestIdIdGet(ctx, id).Limit(limit).Offset(offset).Count(count).Sort(sort).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SmartTestApi.SmartTestIdIdGet(context.Background(), id).Limit(limit).Offset(offset).Count(count).Sort(sort).Execute()
    if err != nil {
...
> SmartTestIdIdPut(ctx, id).SmartTestUpdate1(smartTestUpdate1).Execute()
...
func main() {
    id := int32(56) // int32 | 
    smartTestUpdate1 := *openapiclient.NewSmartTestUpdate1() // SmartTestUpdate1 |  (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SmartTestApi.SmartTestIdIdPut(context.Background(), id).SmartTestUpdate1(smartTestUpdate1).Execute()
    if err != nil {
 ...
 **smartTestUpdate1** | [**SmartTestUpdate1**](SmartTestUpdate1.md) |  | 
...
> SmartTestManualTestPost(ctx).RequestBody(requestBody).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SmartTestApi.SmartTestManualTestPost(context.Background()).RequestBody(requestBody).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SmartTestApi.SmartTestPost(context.Background()).SmartTestCreate0(smartTestCreate0).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.SmartTestApi.SmartTestResultsGet(context.Background()).Limit(limit).Offset(offset).Count(count).Sort(sort).Execute()
    if err != nil {
