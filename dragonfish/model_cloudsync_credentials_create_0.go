...
// CloudsyncCredentialsCreate0 struct for CloudsyncCredentialsCreate0
...
func NewCloudsyncCredentialsCreate0() *CloudsyncCredentialsCreate0 {
	this := CloudsyncCredentialsCreate0{}
	return &this
}
...
func (o CloudsyncCredentialsCreate0) MarshalJSON() ([]byte, error) {
...
type NullableCloudsyncCredentialsCreate0 struct {
	value *CloudsyncCredentialsCreate0
	isSet bool
}

func (v NullableCloudsyncCredentialsCreate0) Get() *CloudsyncCredentialsCreate0 {
	return v.value
}

func (v *NullableCloudsyncCredentialsCreate0) Set(val *CloudsyncCredentialsCreate0) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudsyncCredentialsCreate0) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudsyncCredentialsCreate0) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudsyncCredentialsCreate0(val *CloudsyncCredentialsCreate0) *NullableCloudsyncCredentialsCreate0 {
	return &NullableCloudsyncCredentialsCreate0{value: val, isSet: true}
}

func (v NullableCloudsyncCredentialsCreate0) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudsyncCredentialsCreate0) UnmarshalJSON(src []byte) error {
	v.isSet = true
