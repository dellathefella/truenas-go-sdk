...
type _UserSetAttribute UserSetAttribute
...
func (o *UserSetAttribute) UnmarshalJSON(bytes []byte) (err error) {
	varUserSetAttribute := _UserSetAttribute{}

	if err = json.Unmarshal(bytes, &varUserSetAttribute); err == nil {
		*o = UserSetAttribute(varUserSetAttribute)
	}
