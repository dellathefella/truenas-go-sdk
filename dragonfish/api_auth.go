...
func (r ApiAuthSessionsGetRequest) Execute() (*http.Response, error) {
...
*/
func (a *AuthApiService) AuthSessionsGet(ctx context.Context) ApiAuthSessionsGetRequest {
	return ApiAuthSessionsGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *AuthApiService) AuthSessionsGetExecute(r ApiAuthSessionsGetRequest) (*http.Response, error) {
	var (
