...
func main() {
    ...
    resp, r, err := apiClient.RsynctaskApi.RsynctaskGet(context.Background()).Limit(limit).Offset(offset).Count(count).Sort(sort).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RsynctaskApi.RsynctaskIdIdDelete(context.Background(), id).Execute()
    if err != nil {
...
> RsynctaskIdIdGet(ctx, id).Limit(limit).Offset(offset).Count(count).Sort(sort).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RsynctaskApi.RsynctaskIdIdGet(context.Background(), id).Limit(limit).Offset(offset).Count(count).Sort(sort).Execute()
    if err != nil {
...
> RsynctaskIdIdPut(ctx, id).RsynctaskUpdate1(rsynctaskUpdate1).Execute()
...
func main() {
    id := int32(56) // int32 | 
    rsynctaskUpdate1 := *openapiclient.NewRsynctaskUpdate1() // RsynctaskUpdate1 |  (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RsynctaskApi.RsynctaskIdIdPut(context.Background(), id).RsynctaskUpdate1(rsynctaskUpdate1).Execute()
    if err != nil {
 ...
 **rsynctaskUpdate1** | [**RsynctaskUpdate1**](RsynctaskUpdate1.md) |  | 
...
> RsynctaskIdIdRunPost(ctx, id).Body(body).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RsynctaskApi.RsynctaskIdIdRunPost(context.Background(), id).Body(body).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.RsynctaskApi.RsynctaskPost(context.Background()).RsynctaskCreate0(rsynctaskCreate0).Execute()
    if err != nil {
