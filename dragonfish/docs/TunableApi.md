...
func main() {
    ...
    resp, r, err := apiClient.TunableApi.TunableGet(context.Background()).Limit(limit).Offset(offset).Count(count).Sort(sort).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.TunableApi.TunableIdIdDelete(context.Background(), id).Execute()
    if err != nil {
...
> TunableIdIdGet(ctx, id).Limit(limit).Offset(offset).Count(count).Sort(sort).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.TunableApi.TunableIdIdGet(context.Background(), id).Limit(limit).Offset(offset).Count(count).Sort(sort).Execute()
    if err != nil {
...
> TunableIdIdPut(ctx, id).TunableUpdate1(tunableUpdate1).Execute()
...
func main() {
    id := int32(56) // int32 | 
    tunableUpdate1 := *openapiclient.NewTunableUpdate1() // TunableUpdate1 |  (optional)

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.TunableApi.TunableIdIdPut(context.Background(), id).TunableUpdate1(tunableUpdate1).Execute()
    if err != nil {
 ...
 **tunableUpdate1** | [**TunableUpdate1**](TunableUpdate1.md) |  | 
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.TunableApi.TunablePost(context.Background()).TunableCreate0(tunableCreate0).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.TunableApi.TunableTunableTypeChoicesGet(context.Background()).Execute()
    if err != nil {
