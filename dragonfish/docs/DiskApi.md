...
[**DiskLabelToDevDiskCacheGet**](DiskApi.md#DiskLabelToDevDiskCacheGet) | **Get** /disk/label_to_dev_disk_cache | 
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.DiskApi.DiskGetEncryptedPost(context.Background()).DiskGetEncrypted0(diskGetEncrypted0).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.DiskApi.DiskIdIdGet(context.Background(), id).Limit(limit).Offset(offset).Count(count).Sort(sort).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.DiskApi.DiskIdIdPut(context.Background(), id).DiskUpdate1(diskUpdate1).Execute()
    if err != nil {
...
> DiskLabelToDevDiskCacheGet(ctx).Execute()
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.DiskApi.DiskLabelToDevDiskCacheGet(context.Background()).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `DiskApi.DiskLabelToDevDiskCacheGet``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
}
```
...
Other parameters are passed through a pointer to a apiDiskLabelToDevDiskCacheGetRequest struct via the builder pattern
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.DiskApi.DiskLabelToDevGet(context.Background()).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.DiskApi.DiskOverprovisionPost(context.Background()).DiskOverprovision(diskOverprovision).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.DiskApi.DiskSedDevNameGet(context.Background()).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.DiskApi.DiskSpindownPost(context.Background()).Body(body).Execute()
    if err != nil {
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.DiskApi.DiskUnoverprovisionPost(context.Background()).Body(body).Execute()
    if err != nil {
