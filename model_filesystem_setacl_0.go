...
type FilesystemSetacl0 struct {
	...
	Dacl       []FilesystemSetacl0DaclInner `json:"dacl,omitempty"`
...
func (o *FilesystemSetacl0) GetDacl() []FilesystemSetacl0DaclInner {
	if o == nil || o.Dacl == nil {
		var ret []FilesystemSetacl0DaclInner
		return ret
	}
	return o.Dacl
}
...
// SetDacl gets a reference to the given []FilesystemSetacl0DaclInner and assigns it to the Dacl field.
