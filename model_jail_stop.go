...
func (o *JailStop) UnmarshalJSON(bytes []byte) (err error) {
	varJailStop := _JailStop{}

	if err = json.Unmarshal(bytes, &varJailStop); err == nil {
		*o = JailStop(varJailStop)
	}
