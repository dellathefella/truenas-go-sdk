...
// VmUpdate1 struct for VmUpdate1
...
func (o *VmUpdate1) SetGrubconfigNil() {
...
func (o VmUpdate1) MarshalJSON() ([]byte, error) {
...
type NullableVmUpdate1 struct {
	value *VmUpdate1
	isSet bool
}

func (v NullableVmUpdate1) Get() *VmUpdate1 {
	return v.value
}

func (v *NullableVmUpdate1) Set(val *VmUpdate1) {
	v.value = val
	v.isSet = true
}

func (v NullableVmUpdate1) IsSet() bool {
	return v.isSet
}

func (v *NullableVmUpdate1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVmUpdate1(val *VmUpdate1) *NullableVmUpdate1 {
	return &NullableVmUpdate1{value: val, isSet: true}
}

func (v NullableVmUpdate1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVmUpdate1) UnmarshalJSON(src []byte) error {
	v.isSet = true
