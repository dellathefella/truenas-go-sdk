...
func (r ApiListServicesRequest) Count(count bool) ApiListServicesRequest {
	r.count = &count
	return r
}
...
//
//	@return []Service
func (a *ServiceApiService) ListServicesExecute(r ApiListServicesRequest) ([]Service, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
