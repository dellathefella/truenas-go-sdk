...
type ApiSmbGroupmapAddmemGetRequest struct {
	ctx        context.Context
	ApiService *SmbApiService
}

func (r ApiSmbGroupmapAddmemGetRequest) Execute() (*http.Response, error) {
	return r.ApiService.SmbGroupmapAddmemGetExecute(r)
}

/*
SmbGroupmapAddmemGet Method for SmbGroupmapAddmemGet

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiSmbGroupmapAddmemGetRequest
*/
func (a *SmbApiService) SmbGroupmapAddmemGet(ctx context.Context) ApiSmbGroupmapAddmemGetRequest {
	return ApiSmbGroupmapAddmemGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *SmbApiService) SmbGroupmapAddmemGetExecute(r ApiSmbGroupmapAddmemGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SmbApiService.SmbGroupmapAddmemGet")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/smb/groupmap_addmem"
...
type ApiSmbGroupmapListmemGetRequest struct {
	ctx        context.Context
	ApiService *SmbApiService
}

func (r ApiSmbGroupmapListmemGetRequest) Execute() (*http.Response, error) {
	return r.ApiService.SmbGroupmapListmemGetExecute(r)
}

/*
SmbGroupmapListmemGet Method for SmbGroupmapListmemGet

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiSmbGroupmapListmemGetRequest
*/
func (a *SmbApiService) SmbGroupmapListmemGet(ctx context.Context) ApiSmbGroupmapListmemGetRequest {
	return ApiSmbGroupmapListmemGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *SmbApiService) SmbGroupmapListmemGetExecute(r ApiSmbGroupmapListmemGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SmbApiService.SmbGroupmapListmemGet")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/smb/groupmap_listmem"
...
type ApiSmbJsonCheckVersionGetRequest struct {
	ctx        context.Context
	ApiService *SmbApiService
}

func (r ApiSmbJsonCheckVersionGetRequest) Execute() (*http.Response, error) {
	return r.ApiService.SmbJsonCheckVersionGetExecute(r)
}

/*
SmbJsonCheckVersionGet Method for SmbJsonCheckVersionGet

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiSmbJsonCheckVersionGetRequest
*/
func (a *SmbApiService) SmbJsonCheckVersionGet(ctx context.Context) ApiSmbJsonCheckVersionGetRequest {
	return ApiSmbJsonCheckVersionGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *SmbApiService) SmbJsonCheckVersionGetExecute(r ApiSmbJsonCheckVersionGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SmbApiService.SmbJsonCheckVersionGet")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/smb/json_check_version"
...
type ApiSmbUpdatePayloadWithDiffGetRequest struct {
	ctx        context.Context
	ApiService *SmbApiService
}

func (r ApiSmbUpdatePayloadWithDiffGetRequest) Execute() (*http.Response, error) {
	return r.ApiService.SmbUpdatePayloadWithDiffGetExecute(r)
}

/*
SmbUpdatePayloadWithDiffGet Method for SmbUpdatePayloadWithDiffGet

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiSmbUpdatePayloadWithDiffGetRequest
*/
func (a *SmbApiService) SmbUpdatePayloadWithDiffGet(ctx context.Context) ApiSmbUpdatePayloadWithDiffGetRequest {
	return ApiSmbUpdatePayloadWithDiffGetRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
// Execute executes the request
func (a *SmbApiService) SmbUpdatePayloadWithDiffGetExecute(r ApiSmbUpdatePayloadWithDiffGetRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodGet
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SmbApiService.SmbUpdatePayloadWithDiffGet")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/smb/update_payload_with_diff"
