...
type PoolDatasetUpdate1 struct {
	...
	QuotaWarning          *PoolDatasetUpdate1QuotaWarning `json:"quota_warning,omitempty"`
	QuotaCritical         *PoolDatasetUpdate1QuotaWarning `json:"quota_critical,omitempty"`
	Refquota              NullableInt32                   `json:"refquota,omitempty"`
	RefquotaWarning       *PoolDatasetUpdate1QuotaWarning `json:"refquota_warning,omitempty"`
	RefquotaCritical      *PoolDatasetUpdate1QuotaWarning `json:"refquota_critical,omitempty"`
	Reservation           *int32                          `json:"reservation,omitempty"`
	Refreservation        *int32                          `json:"refreservation,omitempty"`
	SpecialSmallBlockSize *PoolDatasetUpdate1QuotaWarning `json:"special_small_block_size,omitempty"`
...
func (o *PoolDatasetUpdate1) GetQuotaWarning() PoolDatasetUpdate1QuotaWarning {
	if o == nil || o.QuotaWarning == nil {
		var ret PoolDatasetUpdate1QuotaWarning
		return ret
	}
...
// SetQuotaWarning gets a reference to the given PoolDatasetUpdate1QuotaWarning and assigns it to the QuotaWarning field.
...
// SetQuotaCritical gets a reference to the given PoolDatasetUpdate1QuotaWarning and assigns it to the QuotaCritical field.
...
// SetRefquotaWarning gets a reference to the given PoolDatasetUpdate1QuotaWarning and assigns it to the RefquotaWarning field.
...
// SetRefquotaCritical gets a reference to the given PoolDatasetUpdate1QuotaWarning and assigns it to the RefquotaCritical field.
...
// SetSpecialSmallBlockSize gets a reference to the given PoolDatasetUpdate1QuotaWarning and assigns it to the SpecialSmallBlockSize field.
